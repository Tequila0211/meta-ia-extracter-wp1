...
def insert_outcome(
    ...
    outcome = Outcome(
        ...
        intervention_unit=data.get("intervention_unit"),
        ...
        column_label_baseline=data.get("column_label_baseline"),
        column_label_intervention=data.get("column_label_intervention"),
