...
class Outcome(Base):
    ...
    baseline_unit = Column(Text)
    intervention_value = Column(Float)
    intervention_unit = Column(Text)
    ...
    standardized_baseline_value = Column(Float)
    standardized_intervention_value = Column(Float)
    ...
    column_label_baseline = Column(Text)
    column_label_intervention = Column(Text)
