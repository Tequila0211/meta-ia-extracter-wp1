    ...
    with DatabaseManager() as session:
        ...
        for o in outcomes:
            ...
            outcomes_data.append({
                ...
                "status": o.status,
                "human_decision": "",
                "human_baseline_value": None,
                "human_intervention_value": None,
                "human_unit": "",
                "reviewer": "",
                "reviewer_comment": "",
            })
    ...
    with pd.ExcelWriter(output_path, engine="openpyxl") as writer:
        ...
        readme_df = pd.DataFrame({
            "Instructions": [
                ...
                "  - human_baseline_value: corrected value if needed",
                "  - human_intervention_value: corrected value if needed",
